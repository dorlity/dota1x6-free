	...
	if (sub_data && sub_data.player_items_onequip)
	{
		...
		if (hero_items)
		{
	        for (var i = 1; i <= Object.keys(hero_items).length; i++) 
	        {
	            ...
	            if (String(hero_items[i]) == "12930" )
	            {
	            	return "npc_dota_hero_queenofpain_alt1"
	            }
	            if (String(hero_items[i]) == "1293001" )
	            {
	            	return "npc_dota_hero_queenofpain_alt2"
	            }
	            if (String(hero_items[i]) == "13456" )
	            {
	            	return "npc_dota_hero_skeleton_king_alt1"
	            }
	            if (String(hero_items[i]) == "1345601" )
	            {
	            	return "npc_dota_hero_skeleton_king_alt2"
	            }
	            if (String(hero_items[i]) == "905001" || String(hero_items[i]) == "905002" || String(hero_items[i]) == "905003" || String(hero_items[i]) == "905004")
	            {
	            	return "npc_dota_hero_monkey_king_alt1"
	            }
	        }
	    }
	}
