var parentHUDElements = $.GetContextPanel().GetParent().GetParent().GetParent().FindChild("HUDElements");
 ...
 $.GetContextPanel().FindChildTraverse("HuskarInner_panel").SetParent(parentHUDElements)
 $.GetContextPanel().FindChildTraverse("JuggernautWard_panel").SetParent(parentHUDElements)
...
function init()
{
  ...
  GameEvents.Subscribe_custom('jugger_blink_change', jugger_blink_change)
  ...
  GameEvents.Subscribe_custom('huskar_spears_change', huskar_spears_change)
  ...
  GameEvents.Subscribe_custom('jugger_ward_change', jugger_ward_change)

  GameEvents.Subscribe_custom('huskar_inner_change', huskar_inner_change)
...
function jugger_ward_change(kv)
{
  let main = parentHUDElements.FindChildTraverse("JuggernautWard_panel")

  if (main.BHasClass("JuggernautWard_panel_hidden"))
  {
    main.RemoveClass("JuggernautWard_panel_hidden")
    main.AddClass("JuggernautWard_panel")
  }

  let filler = main.FindChildTraverse("JuggernautWard_filler")

  if ((kv.hide == 1) && (main.BHasClass("JuggernautWard_panel")))
  {
    main.RemoveClass("JuggernautWard_panel")
    main.AddClass("JuggernautWard_panel_hidden")
    filler.style.width = '100%'
  ...
  let number = main.FindChildTraverse("JuggernautWard_number")
  number.text = String(damage)
}
...
function huskar_inner_change(kv)
{
  let main = parentHUDElements.FindChildTraverse("HuskarInner_panel")

  if (main.BHasClass("HuskarInner_panel_hidden"))
  {
    main.RemoveClass("HuskarInner_panel_hidden")
    main.AddClass("HuskarInner_panel")
  }

  let filler = main.FindChildTraverse("HuskarInner_filler")

  if ((kv.hide == 1) && (main.BHasClass("HuskarInner_panel")))
  {
    main.RemoveClass("HuskarInner_panel")
    main.AddClass("HuskarInner_panel_hidden")
    filler.style.width = '100%'
  ...
  if (kv.active == 0)
  {
    filler.RemoveClass("HuskarInner_filler_active")
    filler.AddClass("HuskarInner_filler")
  }else 
  {
    filler.RemoveClass("HuskarInner_filler")
    filler.AddClass("HuskarInner_filler_active")
  ...
  let number = main.FindChildTraverse("HuskarInner_number")
  number.text = String(damage)
}
...
function huskar_spears_change(kv)
{

  let main = $.GetContextPanel().FindChildTraverse("Huskar_Spears_Panel")
  if (main.BHasClass("Huskar_Spears_Panel_hidden"))
  {
    main.RemoveClass("Huskar_Spears_Panel_hidden")
    main.AddClass("Huskar_Spears_Panel")
  }


  let filler = $.GetContextPanel().FindChildTraverse("Huskar_Spears_buff_filler")
  let filler_timer = $.GetContextPanel().FindChildTraverse("Huskar_Spears_buff_timer")
  let number = $.GetContextPanel().FindChildTraverse("Huskar_Spears_spawn_timer")
  let active = $.GetContextPanel().FindChildTraverse("Huskar_Spears_Icon")
...
function jugger_blink_change(kv)
{

  let main = $.GetContextPanel().FindChildTraverse("Jugger_Blink_Panel")
  if (main.BHasClass("Jugger_Blink_Panel_hidden"))
  {
    main.RemoveClass("Jugger_Blink_Panel_hidden")
    main.AddClass("Jugger_Blink_Panel")
  }


  let filler = $.GetContextPanel().FindChildTraverse("Jugger_Blink_Filler")
  ...
  let number = $.GetContextPanel().FindChildTraverse("Jugger_Blink_Number")
  let icon = $.GetContextPanel().FindChildTraverse("Jugger_Blink_Icon")
  ...
  if (kv.damage >= kv.max)
  {
    if (icon.BHasClass("Jugger_Blink_Icon"))
    {
      icon.RemoveClass("Jugger_Blink_Icon")
      icon.AddClass("Jugger_Blink_Icon_active")
    }
 }else 
 {
    if (icon.BHasClass("Jugger_Blink_Icon_active"))
    {
      icon.RemoveClass("Jugger_Blink_Icon_active")
      icon.AddClass("Jugger_Blink_Icon")
    }
