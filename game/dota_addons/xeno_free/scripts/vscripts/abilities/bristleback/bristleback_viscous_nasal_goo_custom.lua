...
if vLocation ~= nil then 
  ...
  shard_unit = CreateUnitByName("npc_dota_companion", vLocation, false, self:GetCaster(), self:GetCaster(), self:GetCaster():GetTeamNumber())
  shard_unit:AddNewModifier(unit, self, "modifier_invulnerable", {})
