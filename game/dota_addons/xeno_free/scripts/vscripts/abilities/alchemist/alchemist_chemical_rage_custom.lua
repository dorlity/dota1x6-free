...
alchemist_chemical_rage_custom.cd = {-8,-12,-16}
...
alchemist_chemical_rage_custom.attack_slow = {-6,-9,-12}
...
alchemist_chemical_rage_custom.range_attack = 80
...
return ability:GetSpecialValueFor("speed")*self:GetCaster():GetUpgradeStack("modifier_alchemist_rage_4")*self:GetStackCount()
end
...
if not self:GetParent():HasModifier("modifier_alchemist_rage_2") or true then return end
