...
crystal_maiden_arcane_aura_custom.shield_mana = 0.15
crystal_maiden_arcane_aura_custom.shield_absorb = 0.8
crystal_maiden_arcane_aura_custom.shield_resist = 30
...
if self:GetCaster():HasShard() then
  return DOTA_ABILITY_BEHAVIOR_NO_TARGET + DOTA_ABILITY_BEHAVIOR_DONT_RESUME_MOVEMENT + DOTA_ABILITY_BEHAVIOR_DONT_RESUME_ATTACK + DOTA_ABILITY_BEHAVIOR_IGNORE_BACKSWING + DOTA_ABILITY_BEHAVIOR_IGNORE_CHANNEL + DOTA_ABILITY_BEHAVIOR_IMMEDIATE
end
...
return self:GetCaster():GetTalentValue("modifier_maiden_arcane_7", "speed")
end
...
if self:GetParent():GetMana() < self:GetParent():GetMaxMana()*self:GetCaster():GetTalentValue("modifier_maiden_arcane_7", "mana")/100 then return end
...
self:StartIntervalThink(self:GetCaster():GetTalentValue("modifier_maiden_arcane_7", "cd"))
self.attack = true

if not self.proc then return end

local damage = self:GetParent():GetMaxMana()*self:GetCaster():GetTalentValue("modifier_maiden_arcane_7", "mana")/100
...
if self:GetParent():HasModifier("modifier_maiden_arcane_3") then 
  params.target:AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_crystal_maiden_arcane_aura_custom_slow", {duration = self:GetCaster():GetTalentValue("modifier_maiden_arcane_3", "duration")})
end


if self:GetParent():HasModifier("modifier_maiden_arcane_6") and not self:GetParent():HasModifier("modifier_crystal_maiden_arcane_aura_custom_spell") and not params.no_attack_cooldown then 
  self:GetParent():AddNewModifier(self:GetCaster(), self:GetAbility(),"modifier_crystal_maiden_arcane_aura_custom_spell_count", {duration = self:GetCaster():GetTalentValue("modifier_maiden_arcane_6", "duration")})
end


if self:GetCaster():HasModifier("modifier_maiden_arcane_2") then 
  self:GetParent():AddNewModifier(self:GetCaster(), self:GetAbility(),"modifier_crystal_maiden_arcane_aura_custom_damage", {duration = self:GetCaster():GetTalentValue("modifier_maiden_arcane_2", "duration")})
end 
...
local damage = self:GetParent():GetMaxMana()*(self:GetCaster():GetTalentValue("modifier_maiden_arcane_7", "mana")/100)*(self:GetCaster():GetTalentValue("modifier_maiden_arcane_7", "damage")/100)
...
if self:GetParent():HasModifier("modifier_maiden_arcane_4") then 
  self:GetParent():AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_crystal_maiden_arcane_aura_custom_speed", {duration = self:GetCaster():GetTalentValue("modifier_maiden_arcane_4", "duration")})
end

if self:GetParent():HasModifier("modifier_maiden_arcane_3") then 
  self:GetParent():AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_crystal_maiden_arcane_aura_custom_slow_speed", {duration = self:GetCaster():GetTalentValue("modifier_maiden_arcane_3", "duration")})
end



if not self:GetParent():HasModifier("modifier_maiden_arcane_1") then return end
self:GetParent():AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_crystal_maiden_arcane_aura_custom_mana", {duration = self:GetCaster():GetTalentValue("modifier_maiden_arcane_1", "duration")})
...
return self:GetCaster():GetTalentValue("modifier_maiden_arcane_7", "regen")
end
