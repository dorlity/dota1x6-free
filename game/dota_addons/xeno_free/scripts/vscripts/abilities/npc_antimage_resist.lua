...
self:GetParent():AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_generic_debuff_immune", {magic = -50, effect = 1, duration = self:GetAbility():GetSpecialValueFor("bkb")})
