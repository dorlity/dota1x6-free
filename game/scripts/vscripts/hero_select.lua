...
hero_changes = 
{
    ["npc_dota_hero_juggernaut"] = {"Healing_Ward","Healing_Ward","Omnislash","Omnislash","Omnislash","Shard"},
    ["npc_dota_hero_phantom_assassin"] = {"Stifling_Dagger","Blur","Coup_de_Grace","Coup_de_Grace","Scepter"},
    ["npc_dota_hero_huskar"] = {"movespeed","Berserkers_Blood","Life_Break","Life_Break","Shard"},
    ...
    ["npc_dota_hero_queenofpain"] = {"Dagger","Blink","Sonic","Scepter"},
    ["npc_dota_hero_terrorblade"] = {"Reflection","Illusion","Illusion","Meta","Sunder","Scepter","Shard"},
    ["npc_dota_hero_bristleback"] = {"Goo","Goo","Goo","Scepter"},
    ...
    ["npc_dota_hero_axe"] = {"call","call","hunger","helix","culling","culling","culling","Shard"},
    ...
    ["npc_dota_hero_bloodseeker"] = {"Bloodrite", "Thirst","Thirst","Rupture","Rupture","Scepter"},
    ...
    ["npc_dota_hero_crystal_maiden"] = {"movespeed","Crystal","Frostbite","Frostbite","Arcane","Arcane","Freezing","Freezing","Shard","Scepter"},
