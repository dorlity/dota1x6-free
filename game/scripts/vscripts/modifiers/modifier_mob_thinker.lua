...
if (attacker:GetQuest() and not attacker:QuestCompleted()) then 
	...
	if unit:IsRealHero() then 
		...
		if attacker:GetQuest() == "Jugg.Quest_5" and params.inflictor and (params.inflictor:GetName() == "custom_juggernaut_blade_fury" or params.inflictor:GetName() == "custom_juggernaut_whirling_blade_custom") then 
			attacker:UpdateQuest(damage)
		end
