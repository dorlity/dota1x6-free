...
items_data["npc_dota_hero_queenofpain"] = require("donate_items/npc_dota_hero_queenofpain")
items_data["npc_dota_hero_skeleton_king"] = require("donate_items/npc_dota_hero_skeleton_king")
items_data["npc_dota_hero_monkey_king"] = require("donate_items/npc_dota_hero_monkey_king")
