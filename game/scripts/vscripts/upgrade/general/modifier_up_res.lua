...
modifier_up_res.cd = 240
modifier_up_res.heal = 0.2
...
function modifier_up_res:GetMinHealth()
...
self:GetParent():GenericHeal(self:GetParent():GetMaxHealth()*self.heal, nil)
