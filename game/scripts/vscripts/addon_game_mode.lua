...
PrecacheResource( "soundfile", "soundevents/queenofpain_vo_custom.vsndevts", context ) 
PrecacheResource( "soundfile", "soundevents/skeleton_king_vo_custom.vsndevts", context ) 
PrecacheResource( "soundfile", "soundevents/monkey_king_vo_custom.vsndevts", context ) 
...
if new_spawned_hero and new_spawned_hero:IsHero() and new_spawned_hero.first_spawn_model == nil then
    ...
    if new_spawned_hero:GetUnitName() == "npc_dota_hero_skeleton_king" and new_spawned_hero:GetModelName() ~= "models/items/wraith_king/arcana/wraith_king_arcana.vmdl" then
	    shop:UpdateWraithKingAmbient(new_spawned_hero, false)
	end
end
