...
LinkLuaModifier("modifier_bloodseeker_rupture_custom_heal", "abilities/bloodseeker/bloodseeker_rupture_custom", LUA_MODIFIER_MOTION_NONE)
...
if self:GetCaster():HasModifier("modifier_bloodseeker_rupture_2") then 
	self:GetCaster():AddNewModifier(self:GetCaster(), self, "modifier_bloodseeker_rupture_custom_heal", {duration = duration})
end 
...
modifier_bloodseeker_rupture_custom_heal = class({})
function modifier_bloodseeker_rupture_custom_heal:IsHidden() return true end
function modifier_bloodseeker_rupture_custom_heal:IsPurgable() return false end
function modifier_bloodseeker_rupture_custom_heal:OnCreated()

self.heal = self:GetCaster():GetTalentValue("modifier_bloodseeker_rupture_2", "heal")
end

function modifier_bloodseeker_rupture_custom_heal:DeclareFunctions()
return
{
...
function modifier_bloodseeker_rupture_custom_heal:GetModifierConstantHealthRegen()
return self.heal
end
