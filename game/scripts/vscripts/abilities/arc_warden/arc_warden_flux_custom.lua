...
if self.caster:HasModifier("modifier_arc_warden_flux_2") then 
	self.parent:AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_arc_warden_flux_custom_incoming",{duration = self.caster:GetTalentValue("modifier_arc_warden_flux_2", "duration")})
end 
