...
function custom_queenofpain_shadow_strike:GetAbilityTextureName()
    if self:GetCaster():HasModifier("modifier_queenofpain_ti_8_weapon_custom") then
        return "queen_of_pain/ti8_immortal_weapon/queenofpain_shadow_strike_immortal"
    elseif self:GetCaster():HasModifier("modifier_queenofpain_ti_8_weapon_custom_golden") then
        return "queen_of_pain/ti8_immortal_weapon/queenofpain_shadow_strike_gold_immortal"
    elseif self:GetCaster():HasModifier("modifier_queenofpain_arcana_custom_1") then
        return "queen_of_pain/arcana/queenofpain_shadow_strike_alt1"
    elseif self:GetCaster():HasModifier("modifier_queenofpain_arcana_custom_2") then
        return "queen_of_pain/arcana/queenofpain_shadow_strike_alt2"
    end
...
my_game:PrecacheShopItems("npc_dota_hero_queenofpain", context)
end
...
local proj_name = "particles/units/heroes/hero_queenofpain/queen_shadow_strike.vpcf"
if self:GetCaster():HasModifier("modifier_queenofpain_ti_8_weapon_custom") then
    proj_name = "particles/econ/items/queen_of_pain/qop_ti8_immortal/queen_ti8_shadow_strike.vpcf"
end
if self:GetCaster():HasModifier("modifier_queenofpain_ti_8_weapon_custom_golden") then
    proj_name = "particles/econ/items/queen_of_pain/qop_ti8_immortal/queen_ti8_golden_shadow_strike.vpcf"
end
...
local particle_name = "particles/units/heroes/hero_queenofpain/queen_shadow_strike_body.vpcf"
if self:GetCaster():HasModifier("modifier_queenofpain_ti_8_weapon_custom") then
    particle_name = "particles/econ/items/queen_of_pain/qop_ti8_immortal/queen_ti8_shadow_strike_body.vpcf"
end
if self:GetCaster():HasModifier("modifier_queenofpain_ti_8_weapon_custom_golden") then
    particle_name = "particles/econ/items/queen_of_pain/qop_ti8_immortal/queen_ti8_shadow_strike_body.vpcf"
end
...
if not self.dagger_pfx then
    local particle_name = "particles/units/heroes/hero_queenofpain/queen_shadow_strike_debuff.vpcf"
    if self:GetCaster():HasModifier("modifier_queenofpain_ti_8_weapon_custom") then
        particle_name = "particles/econ/items/queen_of_pain/qop_ti8_immortal/queen_ti8_shadow_strike_debuff.vpcf"
    end
    if self:GetCaster():HasModifier("modifier_queenofpain_ti_8_weapon_custom_golden") then
        particle_name = "particles/econ/items/queen_of_pain/qop_ti8_immortal/queen_ti8_golden_shadow_strike_debuff.vpcf"
    end
